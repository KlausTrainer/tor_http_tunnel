...
connect(TargetHost, TargetPort) when is_list(TargetHost), is_integer(TargetPort) ->
    ProxyHost = tor_http_tunnel:get_app_env(socks_proxy_host),
    ProxyPort = tor_http_tunnel:get_app_env(socks_proxy_port),
    ProxyConnectTimeout = tor_http_tunnel:get_app_env(socks_proxy_connect_timeout),
